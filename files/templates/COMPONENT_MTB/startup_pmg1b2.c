...
extern const cy_israddress __VECTOR_TABLE[CY_VECTOR_TABLE_SIZE];
    ...
    usbpd_0_interrupt_IRQHandler,             /*  14 Synchronous USBPD[0] Interrupts */
    usbpd_1_interrupt_IRQHandler,             /*  15 Synchronous USBPD[1] Interrupts */
    tcpwm_interrupts_0_IRQHandler,            /*  16 TCPWM counter #0 */
    tcpwm_interrupts_1_IRQHandler             /*  17 TCPWM counter #1 */
};
